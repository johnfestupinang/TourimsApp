...
public class HistoryBookingDetailTuristaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_booking_detail_turista);
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists()){
                                ...
                                if(snapshot.hasChild("Imagen")){
                                    ...
                                    Picasso.with(HistoryBookingDetailTuristaActivity.this)
